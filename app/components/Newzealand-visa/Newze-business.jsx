        ...
        <div className="m-2 p-2" style={{
            ...
            <div className="flex mb-6 flex-col lg:flex-row items-start h-auto lg:space-x-6 space-y-4 lg:space-y-0">
                ...
                <div>
                    ...
                    <p className='mb-6'>There are several pathways to obtaining a New Zealand Business Visa, depending on your objectives and the type of business activity you plan to engage in. The main categories include:</p>
            ...
            <li><b>Investor Visa</b>
                        ...
                        <li><b>Long Term Business Visa</b>
            ...
            <ul className='list-disc mb-6 ml-8'>
                <li><b>Business-Friendly Environment:  </b>New Zealand is known for its ease of doing business, low corruption, and a transparent regulatory environment.</li>
                <li><b>High Quality of Life:   </b>With a world-class healthcare system, excellent education, and breathtaking natural beauty, New Zealand offers a balanced lifestyle for you and your family.</li>
                <li><b>Growing Economy: </b>New Zealand boasts a strong and stable economy, with opportunities across various sectors, including agriculture, technology, and tourism.</li>
                <li><b>Access to Global Markets: </b>New Zealand is strategically located to provide access to both Pacific Rim and global markets, making it an ideal hub for international trade and investment.</li>
            </ul>
            <h3 className='text-black m-2 font-bold text-lg mb-6'>
            Visa Requirements
            </h3>
            ...
            <ul className='list-decimal mb-6 ml-8'>
               ...
               <li>Business plan outlining your proposed business activities</li>
               <li>Health and character requirements (medical exams and police clearance)</li>
               <li>English proficiency (for certain visa types)</li>
            </ul>
            ...
            <ul className='list-decimal mb-6 ml-8'>
                ...
                <li><b>Investor Plus Visa:  </b>NZD 4,500 - NZD 5,500</li>
                <li><b>Global Impact Visa:    </b>NZD 3,000</li>
                <li><b>Long Term Business Visa:  </b>NZD 3,000 - NZD 4,000</li>
            </ul>
            ...
            <ul className='mb-6 ml-8 list-disc'>
                ...
                <li><b>Investor Plus Visa: </b>Various by country</li>
                <li><b>Long Term Business Visa: </b>Varies depending on the location of application</li>
            </ul>
            ...
            <ul className='list-disc mb-6 ml-8'>
                ...
                <li><b>End-to-End Support:  </b>From gathering documentation to submitting your application and following up with immigration authorities, we manage every step of the process.</li>
                <li><b>Comprehensive Business Planning:  </b>We help you craft a solid business plan that meets New Zealand’s visa requirements, increasing your chances of approval.</li>
                <li><b>Streamlined Process:  </b>We ensure that your application is completed accurately and efficiently to minimize delays.</li>
